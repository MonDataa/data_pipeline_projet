...
with DAG(dag_id='d1_ddag',description='Our first DAG',schedule_interval='0 12 * * *',start_date=datetime(2022,12,21),catchup=FALSE) as dag:

dummy1=DummyOperator(task_id="t1",dag=dag)
dummy2=DummyOperator(task_id="t2",dag=dag)
dummy3=DummyOperator(task_id="t3",dag=dag)
